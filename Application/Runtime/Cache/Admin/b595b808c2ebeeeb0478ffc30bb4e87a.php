...
<div id="container">
  <div id="hd">
    <div class="hd-wrap ue-clear">
      ...
      <div class="login-info ue-clear">
        ...
        <div class="login-msg ue-clear"> <a href="<?php echo U('Email/recbox');?>" target="iframe" class="msg-txt">消息</a> <a href="<?php echo U('Email/recbox');?>" target="iframe" class="msg-num">1</a> </div>
      </div>
  ...
  <div id="bd">
    <div class="wrap ue-clear">
      <div class="sidebar">
        ...
        <ul class="nav">
          <li class="office current">
            <div class="nav-header"><a href="javascript:;" date-src="/index.php/Admin/Index/home.html" class="ue-clear"><span>日常办公</span><i class="icon"></i></a></div>
          </li>
          <li class="gongwen">
            ...
            <ul class="subnav">
              ...
              <li><a href="javascript:;" date-src="<?php echo U('Doc/add');?>">公文添加</a></li>
            </ul>
          </li>
          <li class="nav-info">
          ...
          <li class="konwledge">
            ...
            <ul class="subnav">
              ...
              <li><a href="javascript:;" date-src="<?php echo U('Knowledge/add');?>">知识添加</a></li>
            </ul>
          </li>
          <li class="agency">
            ...
            <ul class="subnav">
              ...
              <li><a href="javascript:;" date-src="<?php echo U('Dept/add');?>">部门添加</a></li>
            </ul>
          </li>
          <li class="email">
      ...
      <div class="content">
        <iframe name="iframe" src="/index.php/Admin/Index/home.html" id="iframe" width="100%" height="100%" frameborder="0"></iframe>
      </div>
    </div>
  </div>
