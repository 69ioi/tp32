	...
	<table>
        ...
        <tbody>
        	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td class="content"><?php echo (msubstr($vo["content"],0,15)); ?></td>
                <td class="addtime"><?php echo (date('Y-m-d H:i:s',$vo["addtime"])); ?></td>
                <td class="status"><?php if($vo["isread"] == 0): ?><span style="color: #cc3333;">未读</span><?php else: ?><span style="color: grey">已读</span><?php endif; ?></td>
                <td class="operate">
