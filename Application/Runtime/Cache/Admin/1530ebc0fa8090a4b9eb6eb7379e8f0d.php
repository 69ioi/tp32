...
<body>
<div class="title"><h2>公文修改</h2></div>
...
<div class="main">
	...
	<p class="short-input ue-clear">
    	<label>附件：</label>
        <input name="file" type="file"/>说明：如果需要修改文件则选择文件
    </p>
    <p class="short-input ue-clear">
    	<label>作者：</label>
    ...
    <p class="short-input ue-clear">
    	<label>内容：
        	<script id="editor" type="text/plain" name='content' style="width:800px;height:300px;"><?php echo (htmlspecialchars_decode($data["content"])); ?></script>
        </label>
    </p>
</div>
