...
<div class="main">
	<p class="short-input ue-clear">
        ...
        <select name="to_id">
        	...
        	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value='<?php echo ($vo["id"]); ?>'><?php echo ($vo["truename"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
    </p>
	<p class="short-input ue-clear">
    	<label>标题：</label>
